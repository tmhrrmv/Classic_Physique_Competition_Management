...
// v1.3 - Define AUTH_CHECK_SKIP_AUTO antes de incluir
//        auth_check.php para evitar bucle de redirección
// v1.4 - Mejora: destruye sesión previa antes de crear nueva
//        Evita mezcla de datos si el usuario hace login
//        dos veces seguidas sin cerrar sesión
//      - Mejora: function_exists() antes de llamar a
//        generateSessionFingerprint() por si el orden
//        de includes cambia en el futuro
// ============================================================

// Evitar que auth_check.php fuerce autenticación
...
// -------------------------------------------------------
// Mejora: destruir sesión previa si existe
// Evita que datos de una sesión anterior se mezclen
// con los de la nueva cuando el usuario hace login
// dos veces seguidas sin cerrar sesión
// -------------------------------------------------------
...
// de includes cambia en el futuro
// -------------------------------------------------------
$fingerprint = function_exists('generateSessionFingerprint')
    ? generateSessionFingerprint()
    : hash('sha256', $_SERVER['HTTP_USER_AGENT'] ?? 'unknown');
